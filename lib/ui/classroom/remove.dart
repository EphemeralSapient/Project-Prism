...
class classroomRemoveUi extends StatefulWidget {
  @override
  State<classroomRemoveUi> createState() => _classroomRemoveUiState();
}

class _classroomRemoveUiState extends State<classroomRemoveUi> {
                                          ...
                                          onPressed: () {
                                            setState(() {
                                              global.alert.quickAlert(
                                                  ...
                                                  global.textWidget(
                                                      "WIP | Will complete this functionality in future."));
                                            });
                                            pg.animateToPage(1,
                                                duration:
